...
function runTests(): void {
  ...
  const sortedRandomArr = selectionSort([...randomArr]);
  ...
  const sortedResult = selectionSort([...sortedArr]);
  ...
  const sortedReversedArr = selectionSort([...reversedArr]);
  ...
  const sortedDuplicateArr = selectionSort([...duplicateArr]);
  ...
  const sortedEmptyArr = selectionSort([...emptyArr]);
