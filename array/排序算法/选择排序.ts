...
function runTests(): void {
  ...
  console.log("排序后:", selectionSort([...sortedArr]));

  // 测试3: 逆序数组
  const reversedArr = [5, 4, 3, 2, 1];
  console.log("原始数组:", reversedArr);
  console.log("排序后:", selectionSort([...reversedArr]));

  // 测试4: 重复元素
  const duplicateArr = [3, 1, 4, 1, 5, 9, 2, 6, 5];
  console.log("原始数组:", duplicateArr);
  console.log("排序后:", selectionSort([...duplicateArr]));

  // 测试5: 空数组
  const emptyArr: number[] = [];
  console.log("原始数组:", emptyArr);
  console.log("排序后:", selectionSort([...emptyArr]));
}
