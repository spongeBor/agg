...
function runTests(): void {
  ...
  const sortedRandomArr = heapSort([...randomArr]);
  ...
  const sortedResult = heapSort([...sortedArr]);
  ...
  const sortedReversedArr = heapSort([...reversedArr]);
  ...
  const sortedDuplicateArr = heapSort([...duplicateArr]);
  ...
  const sortedEmptyArr = heapSort([...emptyArr]);
